...
<body>
	<div class="priview-body">
		<div class="priview-header">
			...
			<div class="col-5 text-center"><p class="text-center"><span style="font-size:22px;">সিভিল স্যুইট ম্যানেজমেন্ট সিষ্টেম</span><br> ভূমি মন্ত্রণালয়, বাংলাদেশ সচিবালয়, ঢাকা 
			</div>
