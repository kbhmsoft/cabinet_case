                                ...
                                <div class="form-group">
                                    ...
                                    <select name="office_id" id="office_id" class="form-control-sm form-control">
                                        ...
                                        @foreach ($offices as $value)
                                            <option value="{{ $value->id }}"> {{ $value->office_name_bn }},
                                                {{ $value->upazila_name_bn }} {{ $value->district_name_bn }} </option>
                                        @endforeach
                                    </select>
                                    <span style="color: red">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <button type="submit"
                                    class="btn btn-success mr-2"onclick="return confirm('আপনি কি সংরক্ষণ করতে চান?')">সংরক্ষণ
                                    করুন</button>
                            </div>
                        </div>
                    </div>
