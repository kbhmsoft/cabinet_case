...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<!--begin::Header Mobile-->
		@include('layouts.cabinet.base.header-mobile')
        <!--end::Header Mobile-->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				<!--begin::Aside-->
				@include('layouts.cabinet.base.aside')
				<!--end::Aside-->
		...
		<!-- begin::User Panel-->
		@include('layouts.cabinet.partials.user_panel')
		<!-- end::User Panel-->

		<!--begin::Quick Panel -->
		@include('layouts.cabinet.partials.quick_panel')
		<!--end::Quick Panel-->
