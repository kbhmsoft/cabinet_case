    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                @if (Auth::user()->profile_pic != null && Auth::user()->employee_record_ids == null)
                ...
                @elseif (Auth::user()->profile_image != null)
                    <div class="symbol-label"><img src="{{ Auth::user()->profile_image }}" width="90"
                            height="90">
                    </div>
                    <i class="symbol-badge bg-success"></i>
                @else
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">
                    <?= isset(auth()->user()->govOffice->office_name_bn) ? auth()->user()->govOffice->office_name_bn : '-' ?>
                </div>
                <div class="navi mt-2">
