                    ...
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 mb-5">
                                ...
                                <input type="text" name="case_date" id="case_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->case_date }}">
                            </div>
                            <div class="col-lg-3 mb-5">
                                 <label>ফলাফল</label>
                            ...
                            <fieldset>
                                ...
                                <div class="col-lg-12 mb-5">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sc_receiving_date" id="sc_receiving_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->sc_receiving_date }}">
                                        </div>
                                ...
                                <div class="form-group">
                                    <label>কারণ দর্শাইবার আপিল নোটিশ প্রাপ্তির তারিখ</label>
                                        <div></div>
                                    <div class="form-group">
                                        <input type="text" name="send_date_rm_ac" id="send_date_rm_ac" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->send_date_rm_ac }}">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="send_date_ac_ulo" id="send_date_ac_ulo" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->send_date_ac_ulo }}">
                                </div>
                                <div class="form-group">
                                    <label>এস এফ ফাইল ইউ এল ও অফিস থেকে এসি ল্যান্ড অফিসে প্রেরণের তারিখ</label>
                                    <input type="text" name="send_date_sf_ulo_ac" id="send_date_sf_ulo_ac" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->send_date_sf_ulo_ac }}">
                                </div>
                                <div class="form-group">
                                    <label>এস এফ এর জবাব প্রাপ্তির তারিখ</label>
                                    <input type="text" name="send_date_ans_ac_rm" id="send_date_ans_ac_rm" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->send_date_ans_ac_rm }}">
                                </div>
                                <div class="form-group">
                                    <label>এফ এফ প্রতিবেদন চূড়ান্ত করার তারিখ</label>
                                    <input type="text" name="send_date_sf_rm_adc" id="send_date_sf_rm_adc" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->send_date_sf_rm_adc }}">
                                </div>
                            </fieldset>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="order_date" id="order_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->order_date }}">
                                </div>
                                <div class="form-group">
                                    <label>পরবর্তী ধার্য তারিখ</label>
                                    <input type="text" name="next_assign_date" id="next_assign_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->next_assign_date }}">
                                </div>
                                <div class="form-group">
                                    <label>বিগত তারিখের আদেশ</label>
                                    <input type="text" name="past_order_date" id="past_order_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $info->past_order_date }}">
                                </div>
                                <div class="col-lg-12 mb-5">
                                    <div class="form-group">
