...
<div class="row mb-5">
    ...
    <div class="col-md-3">
        <div class="card-counter danger">
            <a href="{{ route('cabinet.case.attroneyHighcourt') }}"><i class="fa fas fa-layer-group text-white"></i></a>
            <span class="count-numbers"><a
                    href="{{ route('cabinet.case.attroneyHighcourt') }}"><?= en2bn($total_high_court_case) ?></a></span>
            <span class="count-name" style="font-size: 14px !important; font-weight: 800 !important;">
                <a href="{{ route('cabinet.case.attroneyHighcourt', 2) }}">হাইকোর্ট বিভাগে মোট মামলা</a></span>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card-counter danger">
            ...
            <span class="count-name" style="font-size: 14px !important; font-weight: 800 !important;">
                <a href="{{ route('cabinet.case.attorney.highcourt.running') }}">হাইকোর্ট বিভাগে চলমান মামলা</a></span>
        </div>
    </div>

    <div class="col-md-3">
        <div class="card-counter danger">
            <a href="{{ route('cabinet.case.attorney.highcourt.complete') }}"><i
...
<div class="row mb-5">
    <div class="col-md-3">
        <div class="card-counter info">
            <a href="{{ route('cabinet.case.attorney.appellateDivision') }}"><i
                    class="fa fas fa-layer-group text-white"></i></a>
            <span class="count-numbers"><a
                    href="{{ route('cabinet.case.attorney.appellateDivision') }}"><?= en2bn($total_appeal_case) ?></a></span>
            <span class="count-name" style="font-size: 15px !important; font-weight: 800 !important;">
                <a href="{{ route('cabinet.case.attorney.appellateDivision') }}">আপিল বিভাগে মোট মামলা</a></span>
        </div>
    </div>

    <div class="col-md-3">
        <div class="card-counter info">
            <a href="{{ route('cabinet.case.attorney.appellateDivision.running') }}"><i
                    class="fa fas fa-layer-group text-white"></i></a>
            <span class="count-numbers"><a
    ...
    <div class="col-md-3">
        <div class="card-counter info">
            <a href="{{ route('cabinet.case.attorney.appellateDivision.complete') }}"><i
                    class="fa fas fa-layer-group text-white"></i></a>
            <span class="count-numbers"><a
