    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="images/logo.png" alt width="250" height="50" class="d-inline-block align-text-top p-0 m-0">
        </a>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-3 col-lg-3 mb-50">
            <div class="footer-widget">
              ...
              <a href="https://minland.gov.bd/" target="_blank"><img style="width: 100px ;float: left;height: 40px;" src="images/logo1.png"
                  alt=""></a>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-3 mb-50">
            <div class="footer-widget">
              ...
              <a href="http://mysoftheaven.com" target="_blank"><img style="width: 120px;height: auto;float: right;"
