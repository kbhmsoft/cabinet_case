		...
		<div class="priview-header">
			<div class="row">
				...
				<div class="col-6 text-center float-left">
					<p class="text-center" style="margin-top: 0;"><span style="font-size:20px;font-weight: bold;">ভূমি রাজস্ব মামলা ম্যানেজমেন্ট সিস্টেম</span><br> ভূমি মন্ত্রণালয়, বাংলাদেশ সচিবালয়, ঢাকা</p> 
			...
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						...
						<th class="text-left" rowspan="2">জেলা নাম</th>
						<th class="text-center" rowspan="2">সর্বমোট মামলা</th>
						<th class="text-center" rowspan="2">চলমান মামলা</th>
						<th class="text-center" rowspan="2">আপিল মামলা</th>
						<th class="text-center" colspan="3">সম্পন্ন মামলা</th>
					</tr>
					<tr>
						<th class="text-center">মোট </th>
						<th class="text-center">পক্ষে </th>
						<th class="text-center">বিপক্ষে </th>
					</tr>
				</thead>
				<tbody>
					<?php 
					...
					foreach ($district_list as $row) { 
						$i++;
						$running = $result_data[$row->id]['running'];
						$appeal = $result_data[$row->id]['appeal'];
						$closed = $result_data[$row->id]['closed'];
						$win = $result_data[$row->id]['win'];
						$lost = $result_data[$row->id]['lost'];
						...
						<tr>
							...
							<td class="text-center"><?=en2bn($running)?></td>
							<td class="text-center"><?=en2bn($appeal)?></td>
							<td class="text-center"><?=en2bn($closed)?></td>
