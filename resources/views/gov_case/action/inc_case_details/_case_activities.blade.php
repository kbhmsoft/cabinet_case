    <div class="container">
        ...
        @if(userInfo()->role_id == 36)
            <a href="javascript:void(0)" id="hearing_add_button" class="btn btn-danger float-right">
                <i class="fa fas fa-landmark"></i> <b>শুনানির তারিখ যুক্ত করুন</b>
            </a>
        @endif
        <div class="clearfix"></div>

        <div id="hearing_content">
            @if (!empty($case->ref_gov_case_no))
            ...
            <div id="caseHearingList">
                @include('gov_case.action.inc_case_details._single_hearing_data')
            </div>
