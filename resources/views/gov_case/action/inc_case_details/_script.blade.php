<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#sfCreateSubmit').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('cabinet.case.action.createsf') }}",
                method: 'post',
                data: {
        ...
        $('#sfUpdateSubmit').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('cabinet.case.action.editsf') }}",
                method: 'post',
                data: {
                    case_id: $('#hide_case_id').val(),
        ...
        $('#ajax-hearing-file-upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('cabinet.case.action.file_store_hearing') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        // $('#hearing_result_upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('cabinet.case.action.hearing_result_upload') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#ajax-file-upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('cabinet.case.action.file_store') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#ajax-caseResult-upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('cabinet.case.action.result_update') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#formSubmit').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('cabinet.case.action.forward') }}",
                method: 'post',
                data: {
                    case_id: $('#hide_case_id').val(),
                    group: radioValue,
