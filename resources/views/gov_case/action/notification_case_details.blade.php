...
<!--begin::Row-->
@include('gov_case/action/inc_case_details/_send_sec')
<!--end::Row-->
            ...
            <div class="card-header card-header-tabs-line">
                <div class="card-toolbar">
                    <ul class="nav nav-tabs nav-success nav-tabs-space-lg nav-tabs-line nav-bolder nav-tabs-line-3x"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" @if(auth()->user()->can('card_full_case')) href="#tab_case_details" @else href="#" @endif >
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" @if(auth()->user()->can('details_sf_report')) href="#tab_sf_report" @else href="#" @endif>
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" @if(auth()->user()->can('details_continuous_activity')) href="#tab_notice" @else href="#" @endif >
                                <span class="nav-icon"><i class="fa far fa-bell mr-5"></i></span>
                                <span class="nav-text font-size-h3">ধারাবাহিক কার্যক্রম</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" @if(auth()->user()->can('details_results')) href="#tab_result" @else href="#" @endif >
                                <span class="nav-icon"><i class="fa fas fa-receipt mr-5"></i></span>
                                <span class="nav-text font-size-h3">ফলাফল</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" @if(auth()->user()->can('details_timeline')) href="#tab_history" @else href="#" @endif >
            ...
            <div class="card-body px-0">
                <div class="tab-content pt-5">
                    ...
                    <div class="tab-pane active" id="tab_case_details" role="tabpanel">
                        @include('gov_case/action/inc_case_details/_full_case')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    {{-- <div class="tab-pane" id="tab_sf" role="tabpanel">
                        @include('gov_case/action/inc_case_details/_sf_tab')
                    </div> --}}
                    <!--end::Tab Content-->
                    ...
                    @if(Auth::user()->role_id == 33 || Auth::user()->role_id == 31 || Auth::user()->role_id == 28)
                        <div class="tab-pane" id="tab_sf_report" role="tabpanel">
                            @include('gov_case/action/inc_case_details/_final_sf')
                        </div>
                    @endif
                    <!--end::Tab Content-->
                    ...
                    <div class="tab-pane" id="tab_notice" role="tabpanel">
                        @include('gov_case/action/inc_case_details/_case_activities')
                    </div>
                    <!--end::Tab Content-->
                    ...
                    <div class="tab-pane" id="tab_result" role="tabpanel">
                        @include('gov_case/action/inc_case_details/_case_result')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_history" role="tabpanel">
                        @include('gov_case/action/inc_case_details/_case_history')
                    </div>
                    <!--end::Tab Content-->
                </div>
            </div>
...
@section('scripts')
   ...
   @include('gov_case.action.inc_case_details._script')
@endsection
