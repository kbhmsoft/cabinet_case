                ...
                <table class="table table-hover mb-6 font-size-h5">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" style="text-align:center; font-size: 12px; vertical-align: middle;">মামলার
                                বিষয়বস্তু</th>
                            <th scope="col" style="text-align:center; font-size: 12px; vertical-align: middle;">রায়
                                বাস্তবায়ন ও আপিল সংক্রান্ত তথ্য</th>
                    ...
                    <tbody>
                        @foreach ($cases as $key => $row)
                            ...
                            <tr>
                                ...
                                <td class="notice-popup" style="text-align:center;">
                                    <div class="product">
                                        <div class="product-image">
                                            @if ($row->result == '2')
                                                <span class="indicator">{{ Str::limit($row->result_short_dtails, 100) ?? '-' }}</span>
                                            @else
