                                        ...
                                        <fieldset class="mb-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4 mb-5">
                                                    ...
                                                    <input disabled type="text" name="case_no" id="case_no"
                                                    ...
                                                    <table width="100%" border="1" id="MainBibadiDiv"
                                                        ...
                                                        <tr>
                                                            <th class="bg-white text-left ml-2" colspan="3">মূল
                                                                রেসপন্ডেন্টের <span class="text-danger">*</span></th>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div class="col-lg-6 mb-5">
                                                    <table width="100%" border="1" id="bibadiDiv" class="mb-5"
                                                        style="border:1px solid #dcd8d8;">
                                                        <tr>
                                                            <th class="bg-white text-left ml-2" colspan="3">অন্যান্য
                                                                রেসপন্ডেন্ট নাম <span class="text-danger">*</span></th>
                                                        </tr>
                                                        <tr>
                                                            <th>মন্ত্রণালয়ের নাম <span class="text-danger">*</span></th>
                                                            <th width="50">
                                                        ...
                                                        @foreach ($caseBibadi as $key => $val)
                                                            @if ($val->is_main_bibadi != 1)
                                                                <tr id="bibadi_00{{ $key }}">
                                                                    <td>
                                                                        <select
                                                                            onchange="getDoptor(this, 'bibadi_00{{ $key }}')"
