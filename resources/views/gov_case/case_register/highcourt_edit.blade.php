...
for ($i = 0; $i < sizeof($concern_person_desig); $i++) { $concernPersonDesig .='<option value="' . $concern_person_desig[$i]->id .
    '">' .
    $concern_person_desig[$i]->name_bn .
    '</option>';
    }
    $pass_year_data = '<option value="">-- নির্বাচন করুন --</option>';
    for ($i = 1995; $i <= date('Y'); $i++) { $pass_year_data .='<option value="' . $i . '">' . $i . '</option>' ; } @endphp @include('gov_case.case_register.create_css') <!--begin::Row-->
        <div class="row">
                ...
                <div id="tab_header_tabs tab-design" class="trainee_details_card_header course_details_new_tabs">
                    <ul class="nav details_trainee_tab nav-tabs myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="trainee_tab_item" data-toggle="tab" href="#case_general_information" role="tab" aria-controls="home" aria-selected="true">মামলার সাধারণ তথ্য</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="sending_reply_tab" data-toggle="tab" href="#sending_reply" role="tab" aria-controls="profile" aria-selected="false">জবাব প্রেরণ</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="suspension_order_tab" href="#suspension_order" data-toggle="tab" role="tab" aria-controls="contact" aria-selected="false">স্থগিতাদেশ/<br>অন্তর্বর্তীকালীন
                                আদেশ সম্পর্কিত</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="final_order_tab" href="#final_order" data-toggle="tab" role="tab" aria-controls="contact" aria-selected="false">চূড়ান্ত আদেশ/<br>রায় সম্পর্কিত</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="contempt_case_tab" href="#contempt_case" data-toggle="tab" role="tab" aria-controls="contact" aria-selected="false">কনটেম্প্ট মামলা/<br>অন্যান্য</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="table-responsive ajax-data-container pt-3">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane active" id="case_general_information" role="tabpanel" aria-labelledby="home-tab">
                                <form id="caseGeneralInfoFormForEdit" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row_int">
                                        <div class="col-lg-12">
                                            <!--begin::Card-->
                                            ...
                                            <fieldset class="mb-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4 mb-5">
                                                        ...
                                                        <div class="" id="CaseCategorDiv">
                                                            <select name="case_category" id="CaseCategory" class="form-control form-control-sm">
                                                                ...
                                                                <option value="{{ $value->id }}" {{ old('case_category') == $value->id || $case->case_category_id == $value->id ? 'selected' : '' }}>
                                                                    {{ $value->name_bn }}
                                                                </option>
                                                                @endforeach
                                                    ...
                                                    <div class="col-lg-4 mb-5">
                                                        ...
                                                        <div class="" id="CaseCategorDiv">
                                                            <select name="case_category_type" id="case_category_type" class="form-control form-control-sm" required="required">
                                                                ...
                                                                <option value="{{ $value->id }}" {{ old('case_category') == $value->id || $case->case_type_id == $value->id ? 'selected' : '' }}>
                                                                    {{ $value->name_bn }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-lg-4 mb-5">
                                                        ...
                                                        <input type="text" name="case_no" id="case_no" class="form-control form-control-sm" placeholder="মামলা নং " value="{{ $case->case_no ?? '' }}" readonly>
                                                    ...
                                                    <div class="col-lg-4 mb-5">
                                                        ...
                                                        <input type="text" name="case_year" id="case_year" class="form-control form-control-sm common_yearpicker" placeholder="বছর" autocomplete="off" value="{{ $case->year ?? '' }}">
                                                        <span class="text-danger d-none vallidation-message">This field can
                                                            not be empty</span>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 mb-5">
                                            ...
                                            <input type="text" name="case_date" id="case_date" class="form-control form-control-sm  common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $case->date_issuing_rule_nishi ?? '' }}">
                                        ...
                                        <div class="col-lg-12 mb-5">
                                            <table width="100%" border="1" id="advocateLawerDiv" style="border:1px solid #dcd8d8;">
                                                <tr>
                                                    ...
                                                    <th width="30">
                                                        <a href="javascript:void(0);" id="addAdvocateLawer" class="btn btn-sm btn-primary pr-2"><i class="fas fa-plus-circle"></i></a>
                                                    </th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <select name="concernPersonDesignation[]" id="concernPersonDesignation_{{ $key + 1 }}" class="form-control form-control-sm" required="required" onchange="getConcernPerName({{ $key + 1 }})">
                                                            @foreach ($concern_person_desig as $data)
                                                            <option value="{{ $data->id }}" {{ old('concern_person_designation') == $data->id || $value->concern_person_designation == $data->id ? 'selected' : '' }}>
                                                                {{ $data->name_bn }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td>
                                                        <select name="concern_user_id[]" id="concern_user_id_{{ $key + 1 }}" class="form-control form-control-sm" required="required">
                                                            @foreach ($lawerInfo as $data)
                                                            <option value="{{ $data->id }}" {{ old('concern_user_id') == $data->id || $value->concern_user_id == $data->id ? 'selected' : '' }}>
                                                                {{ $data->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <td>
                                                        @if ($key > 0)
                                                        <a href="javascript:void();" class="btn btn-sm btn-danger font-weight-bolder pr-2" data-id="{{ $value->id }}" onclick="removeRowBadiBibadiFunc(this, 'ajax_badi_del')">
                                                            <i class="fas fa-minus-circle"></i>
                                                        </a>
                                                        @endif
                                                    </td>
                                                    <input type="hidden" name="concern_person_id[]" value="{{ $value->id }}">
                                                </tr>
                                                <input type="hidden" id="survey_count" value="{{ $key + 2 }}">
                                                @endforeach
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-5">
                                            <table width="100%" border="1" id="badiDiv" style="border:1px solid #dcd8d8;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" name="badi_name[]" class="form-control form-control-sm" value="{{ $caseBadi->name ?? '' }}" placeholder="">
                                                    </td>

                                                    <td>
                                                        <input type="text" name="badi_address[]" class="form-control form-control-sm" value="{{ $caseBadi->address ?? '' }}" placeholder="">
                                                    </td>

                                                    <input type="hidden" name="badi_id[]" value="{{ $caseBadi->id ?? '' }}">
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-lg-5 mb-5">
                                            ...
                                            <select name="total_badi_number" id="total_badi_number" class="form-control form-control-sm">
                                                ...
                                                @for ($i = 1; $i <= 1000; $i++) <option value="{{ $i }}" {{ old('total_badi_number') == $i || $case->total_badi_number == $i ? 'selected' : '' }}>
                                                    {{ $i }}</option>
                                                    @endfor
                                            </select>
                                            ...
                                            <table width="100%" border="1" id="bibadiDiv" class="mb-5" style="border:1px solid #dcd8d8;">
                                                ...
                                                <tr id="bibadi_10{{ $key }}">
                                                    @if($val->respondent_id !=0)
                                                        ...
                                                        <input type="hidden" name="other_respondent_manual_name[]" value="">
                                                        <input type="hidden" name="bibadi_id[]" value="{{ $val->id }}">
                                                    @else
                                                        <td>
                                                            <input type="hidden" name=" other_respondent[]" value="0">
                                                            <input class="form-control form-control-sm" type="text" name="other_respondent_manual_name[]" value="{{ $val->other_respondent_manual_name }}">
                                                        </td>
                                                        <input type="hidden" name="bibadi_id[]" value="{{ $val->id }}">
                                                    @endif
                                                    <td>
                                                        @if ($key > 0)
                                                        <a href="javascript:void();" class="btn btn-sm btn-danger font-weight-bolder pr-2" data-id="{{ $value->doptor_office_id }}" onclick="removeRowBadiBibadiFunc(this, 'ajax_bibadi_del')">
                                                            <i class="fas fa-minus-circle"></i>
                                                        </a>
                                                        @endif
                                                    </td>
                        ...
                        <div class="col-lg-12 mb-5">
                            <div class="col-md-6">
                                ...
                                <div class="radio-inline">
                                    <label class="radio">
                                        <input type="radio" name="postponed_interim_have" id="postponed_interim_have_yes" value="1" {{ $case->postponed_interim_have == 1 ? 'checked' : '' }}>
                                        <span></span>হ্যাঁ
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="postponed_interim_have" id="postponed_interim_have_no" value="0" {{ $case->postponed_interim_have == 0 ? 'checked' : '' }}>
                                        <span></span>না
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="p-5" id="postponed_interim_data_details" style="{{ $case->postponed_interim_have == 1 ? '' : 'display:none;' }}">
                                <div class="col-md-12 mb-5">
                                    <label>স্থগিতাদেশের সংক্ষিপ্ত বিবরণ</label>
                                    <textarea name="postponed_interim_data_details" class="form-control" id="postponed_interim_data_details_textarea" rows="3" spellcheck="false">{{ $case->postponed_interim_data_details }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <fieldset class="">
                                <div class="rounded bg-success-o-75 d-flex align-items-center justify-content-between flex-wrap px-5 py-0">
                                    ...
                                    <div class="symbol-group symbol-hover py-2">
                                        <div class="symbol symbol-30 symbol-light-primary" data-toggle="tooltip" data-placement="top" title="" role="button" data-original-title="ফাইল যুক্ত করুণ">
                                ...
                                <div class="mt-3 px-5">
                                    <table width="100%" class="border-0 px-5" id="mainFileDiv" style="border:1px solid #dcd8d8;">
                                        ...
                                        <tr>
                                            ...
                                            <div class="form-group mb-2" id="deleteFile{{ $row->id }}">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <a href="javascript:void(0);" id="deleteRuleFileBtn_({{ $row->id }}" onclick="deleteRuleFile({{ $row->id }} )" class="btn btn-danger">
                                    ...
                                    <input type="hidden" id="other_main_attachment_count" value="1">
                                </div>
                            </fieldset>
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="sending_reply" role="tabpanel" aria-labelledby="home-tab">
                <form id="sendingReplyForm" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row_int">
                        <div class="col-lg-12">
                            <!--begin::Card-->
                            ...
                            <fieldset class="mb-8">
                                <div class="col-lg-12 mb-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio">
                                                <input type="radio" name="sending_reply_have" id="sending_reply_have" value="1" {{ $case->sending_reply_have == 1 ? 'checked' : '' }} />
                                                <span></span>হ্যাঁ</label>
                                            <label class="radio">
                                                <input type="radio" name="sending_reply_have" id="sending_reply_have_not" value="0" {{ $case->sending_reply_have == 0 ? 'checked' : '' }} />
                                                <span></span>না</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-5" id="sending_reply_data_details">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="solicitor_checkbox" name="sending_reply_person_solicitor" {{ in_array(1, explode(',', $case->sending_reply_person_unit)) ? 'checked' : '' }}>
                                            <label class="form-check-label lawyer_title" for="solicitor_checkbox">সলিসিটর বরাবর</label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" id="law_officer_checkbox" name="sending_reply_person_law_officer" {{ in_array(2, explode(',', $case->sending_reply_person_unit)) ? 'checked' : '' }}>
                                            <label class="form-check-label lawyer_title" for="law_officer_checkbox">আইন কর্মকর্তা/প্যানেল আইনজীবী
                                                বরাবর</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sending_reply_div">
                                        <div class="form-group row">
                                            <div class="col-lg-6 mb-5">
                                                ...
                                                <input type="text" name="result_sending_date" id="result_sending_date" class="form-control form-control-sm  common_datepicker" placeholder="" autocomplete="off" value="{{ $case->result_sending_date ?? '' }}">
                                            </div>
                                            <div class="col-lg-6 mb-5">
                                                <label>দফাওয়ারি জবাব সলিসিটর অনুবিভাগে প্রেরণের স্মারক </label>
                                                <input type="text" name="result_sending_memorial" id="result_sending_memorial" class="form-control form-control-sm" placeholder="" autocomplete="off" value="{{ $case->result_sending_memorial ?? '' }}">
                                            </div>
                                                ...
                                                <fieldset class="">
                                                    ...
                                                    <div class="mt-3 px-5">
                                                        <table width="100%" class="border-0 px-5" id="fileDiv" style="border:1px solid #dcd8d8;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" name="file_type[]" id="customFileName" class="form-control form-control-sm" value="{{ old('file_type', $value->file_type) }}">
                                                                </td>
                                                                <td>
                                                                    <div class="custom-file">

                                                                        @if ($value->file_name)
                                                                        <a target="_blank" class="text-center font-weight-bolder text-primary text-decoration-none d-block w-100 p-2 mb-2 rounded bg-light " href="{{ asset($value->file_name) }}">সংযুক্তি
                                                                            কপি</a><br>
                                                                        @else
                                                    ...
                                                    <div class="mt-3 px-5">
                                                        <table width="100%" class="border-0 px-5" id="replyFileDiv" style="border:1px solid #dcd8d8;">
                                                            <tr></tr>
                                                        </table>
                                            ...
                                            <div class="col-lg-6 mb-5 mt-5">
                                                ...
                                                <input type="text" name="result_sending_date_solisitor_to_ag" id="result_sending_date_solisitor_to_ag" class="form-control form-control-sm  common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $case->result_sending_date_solisitor_to_ag ?? '' }}">
                                            </div>

                                            <div class="col-lg-6 mb- mt-5">
                                                <label>সলিসিটর অফিস হতে এটর্নি জেনারেল অফিসে জবাব প্রেরণের
                                                    স্মারক </label>
                                                <input type="text" name="result_sending_memorial_solisitor_to_ag" id="result_sending_memorial_solisitor_to_ag" class="form-control form-control-sm" placeholder="" autocomplete="off" value="{{ $case->result_sending_memorial_solisitor_to_ag ?? '' }}">
                                            </div>
                                            <div class="col-lg-6 mb-5">
                                                <label>সংশ্লিষ্ট আদালতে জবাব দাখিলের তারিখ </label>
                                                <input type="text" name="reply_submission_date" id="reply_submission_date" class="form-control form-control-sm  common_datepicker" placeholder="দিন/মাস/বছর" autocomplete="off" value="{{ $case->reply_submission_date ?? '' }}">
                                            </div>
        ...
        <div class="tab-pane" id="suspension_order" role="tabpanel" aria-labelledby="home-tab">
            <form id="suspensionOrderForm" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row_int">
                    <div class="col-lg-12">
                        <!--begin::Card-->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <div class="radio-inline">
                                        ...
                                        <label class="radio">
                                            <input type="radio" name="postponed_order" id="postponed_order_have" value="1" {{ $case->postponed_order == '1' ? 'checked' : '' }} />
                                            <span></span>আছে</label>
                                ...
                                <div class="col-lg-6 mb-5">
                                    ...
                                    <input type="text" name="appeal_against_postpond_interim_order" id="appeal_against_postpond_interim_order" class="form-control form-control-sm" placeholder="" autocomplete="off" value="{{ $case->appeal_against_postpond_interim_order ?? '' }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-group font-weight-bolder font-size-h5">অন্তর্বর্তীকালীন
                                        আদেশ </label>
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" name="interim_order" id="interim_order_have" value="1" {{ $case->interim_order == '1' ? 'checked' : '' }} />
                                            <span></span>আছে</label>
                                        <label class="radio">
                            ...
                            <div class="col-md-12">
                                <fieldset class="">
                                    ...
                                    <div class="mt-3 px-5">
                                        <table width="100%" class="border-0 px-5" id="suspensionOrderFileDiv" style="border:1px solid #dcd8d8;">
                                            <tr></tr>
                                        </table>
        ...
        <div class="tab-pane" id="final_order" role="tabpanel" aria-labelledby="home-tab">
            <form id="finalOrderForm" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row_int">
                    <div class="col-lg-12">
                        <!--begin::Card-->
                        ...
                        <fieldset class="mb-8">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 mb-5">
                                    <input type="checkbox" id="is_final_order" name="is_final_order" value="1" onclick="showAlert()" {{ $case->is_final_order == '1' ? 'checked' : '' }}>
                            ...
                            <div id="">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="result_short_dtails" class="form-control" id="result_short_dtails" rows="3" spellcheck="false">{{ $case->result_short_dtails ?? '' }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="">
                                        ...
                                        <div class="mt-3 px-5">
                                            <table width="100%" class="border-0 px-5" id="finalOrderFileDiv" style="border:1px solid #dcd8d8;">
                                                <tr></tr>
                                            </table>
        ...
        <div class="tab-pane" id="contempt_case" role="tabpanel" aria-labelledby="home-tab">
            <form id="contemptCaseForm" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row_int">
                    <div class="col-lg-12">
                        <!--begin::Card-->
                        ...
                        <fieldset>
                            ...
                            <div class="col-md-12">
                                <fieldset class="">
                                    ...
                                    <div class="mt-3 px-5">
                                        <table width="100%" class="border-0 px-5" id="contemptFileDiv" style="border:1px solid #dcd8d8;">
                                            <tr></tr>
                                        </table>
                ...
                <div class="form-footer" style="display: flex;justify-content: center;">
                    <button type="submit" id="contemptCaseSaveBtn" class="action-button submit-button">সংরক্ষণ</button>
                </div>
            </form>
        </div>
        {{-- ------------- end কনটেম্প্ট মামলা------------- --}}
        ...
        <script>
            ...
            function addBibadiRowFunc() {
                ...
                function Item(count) {
                    ...
                    items +=
                        '<td><select name="other_respondent[]" id="other_respondent_' + count + '" class="form-control form-control-sm other_respondentCls" onChange="getManualOtherRespondentName(' + count + ')">';
                    ...
                    items += '</select> <br> <input type="text" name="other_respondent_manual_name[]" id="other_respondent_manual_name_edit_' + count + '" class="form-control form-control-sm d-none" placeholder="অন্যান্য রেসপন্ডেন্টর নাম লিখুন"></td>';
            ...
            function getManualOtherRespondentName(data) {
                ...
                if (selectID == 0) {
                    ...
                    $('#other_respondent_manual_name_edit_' + data).addClass("w-100");
                }
                if (selectID != 0) {
                    $('#other_respondent_manual_name_edit_' + data).addClass("d-none");
                }
