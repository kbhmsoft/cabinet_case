            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <div id="tab_header_tabs tab-design" class="trainee_details_card_header course_details_new_tabs">
                    <ul class="nav details_trainee_tab nav-tabs myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="trainee_tab_item" href="#suspension_order" data-toggle="tab"
                                role="tab" aria-controls="contact" aria-selected="false">স্থগিতাদেশ/অন্তর্বর্তীকালীন
                                আদেশ সম্পর্কিত</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="trainee_tab_item" href="#final_order" data-toggle="tab"
                                role="tab" aria-controls="contact" aria-selected="false">চূড়ান্ত আদেশ/রায় সম্পর্কিত</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="trainee_tab_item" href="#contempt_case" data-toggle="tab"
                                role="tab" aria-controls="contact" aria-selected="false">কনটেম্প্ট মামলা/অন্যান্য</a>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <fieldset class="mb-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4 mb-5" style="display:none;" id="appeal_hide_show">
                                                        <label>মামলা নির্বাচন করুন <span
                                                    ...
                                                    <div class="col-lg-4 mb-5">
                                                        ...
                                                        <input type="text" name="case_no" id="case_no"
                                                            ...
                                                            placeholder="মামলা নং/সাল(০০১/২০২৩) " required="required">
                                                    ...
                                                    <div class="col-lg-12 mb-5">
                                                        <table width="100%" border="1" id="badiDiv"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>পিতা/স্বামীর নাম <span class="text-danger">*</span>
                                                                </th>
                                                    ...
                                                    <div class="col-lg-6 mb-5">
                                                        <table width="100%" border="1" id="MainBibadiDiv"
                                                            ...
                                                            <tr>
                                                                <th class="bg-white text-left ml-2" colspan="3">মূল
                                                                    রেসপন্ডেন্ট </th>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <div class="col-lg-6 mb-5">
                                                        <table width="100%" border="1" id="bibadiDiv"
                                                            class="mb-5" style="border:1px solid #dcd8d8;">
                                                            <tr>
                                                                <th class="bg-white text-left ml-2" colspan="3">
                                                                    অন্যান্য রেসপন্ডেন্ট </th>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    <div class="col-md-2">
                                                        <label
                                                            class="form-group font-weight-bolder font-size-h4">স্থগিতাদেশের
                                                        </label>
                                                    </div>
                                                        <div class="col-lg-8 mb-5">
                                                            ...
                                                            <input type="text"
                                                                name="appeal_against_postpond_interim_order"
                                                    ...
                                                    <div class="col-md-4">
                                                        <label
                                                            class="form-group font-weight-bolder font-size-h4">অন্তর্বর্তীকালীন
                                                            আদেশ </label>

                                                    </div>

                                                    <div class="col-md-8 mb-5" id="">
