...
function addBibadiRowFunc() {
    ...
    function Item(count) {
        var items = '';
        items += '<tr id="bibadi_' + count + '">';
        items += '<td><select name="other_respondent[]" class="form-control form-control-sm other_respondentCls">';
        ...
        items += '</select></td>';
        items += '<td><input type="text" name="other_respondent_manual_name[]" class="form-control form-control-sm d-none" placeholder="অন্যান্য রেসপন্ডেন্টর নাম লিখুন"></td>';
