        ...
        <div class="card-header flex-wrap py-5">
            ...
            <table class="details-pdf-button">
                <tr align="right">
                    <th>
                        &nbsp;
                        <a href="{{ route('cabinet.case.highcourtRegisterPdf', $case->id) }}"
                    ...
                    <table class="table ">
                        <thead>
                            <tr class="bg-light-primary">
                                ...
                                <th scope="row">মূল রেসপন্ডেন্ট নাম </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $case->result_sending_date_solisitor_to_ag ? en2bn($case->result_sending_date_solisitor_to_ag) : '-' }}
                                </td>
                    ...
                    <table class="table ">
                        <thead>
                            <tr class="bg-light-primary">
                                ...
                                <th scope="row">আপিল দায়েরের জন্য অনুরোধের স্মারক</th>
                                <th scope="row">আপিল দায়েরের তারিখ</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $case->result_copy_reciving_date ? en2bn($case->result_copy_reciving_date) : '-' }}
                                </td>
                                <td>{{ $case->appeal_requesting_memorial ?? '-' }}
                                </td>
                                <td>
                                    {{ $case->appeal_requesting_date ? en2bn($case->appeal_requesting_date) : '-' }}
                                </td>
                                <td>{{ $case->reason_of_not_appealing ?? '-' }}</td>
                                <td>{{ $case->contempt_case_no ?? '-' }},{{ $case->contempt_case_isuue_date ? en2bn($case->contempt_case_isuue_date) : '-' }}
                                </td>
                                <td>{{ $case->contempt_case_answer_sending_date ? en2bn($case->contempt_case_answer_sending_date) : '-' }}
                                </td>
