                    ...
                    <table class="table table-hover mb-6 font-size-h6">
                        <thead class="thead-light ">
                            <tr>
                                ...
                                <th style="font-weight: bold; font-size: 1.2em;" style="text-align:center;">মূল বিবাদী হিসেবে অন্তর্ভুক্তির কারণ
                                </th>
                                <th style="font-weight: bold; font-size: 1.2em;" style="text-align:center;">সংযুক্তি
                                </th>
                                <th style="font-weight: bold; font-size: 1.2em;" style="text-align:center;">কার্যক্রম গ্রহণ</th>
                            </tr>
                        </thead>
                        <tbody>
