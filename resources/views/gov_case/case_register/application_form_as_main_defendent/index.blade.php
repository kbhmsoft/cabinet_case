                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th style="font-weight: bold; font-size: 1.2em;">মূল বিবাদী হিসেবে অন্তর্ভুক্তির (পিডিএফ)</th>
                    ...
                    <tbody>
                        @forelse ($cases as $index => $case)
                            ...
                            <tr>
                                ...
                                <td> {{ $case->office_name_bn }} </td>                     
                                <td class="text-truncate" style="max-width: 200px;">{{ $case->main_defendant_comments }}
                                </td>
                                <td class="text-truncate" style="max-width: 200px;">{{ $case->additional_comments }}</td>
                                <td class="text-truncate" style="max-width: 200px;">
                                    <a href="{{ asset('storage/' . $case->main_defendant_pdf) }}" target="_blank"> পিডিএফ
                                        দেখুন </a>
                                </td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">কোনো মূল বিদাদি হিসেবে অন্তর্ভুক্তি পাওয়া যায়নি।
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
