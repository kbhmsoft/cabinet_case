...
<script>
    ...
    $('#administrativeTribrunalGeneralInfoForm').submit(function(e) {
        ...
        $('#administrativeTribrunalGeneralInfoSaveBtn').addClass('spinner spinner-white spinner-right disabled');
        Swal.fire({
            title: 'আপনি কি প্রশাসনিক মামলার সাধারন তথ্য সংরক্ষণ করতে চান?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('cabinet.case.administrativeTribrunalGeneralInfo') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: (data) => {
                        $('#administrativeTribrunalGeneralInfoSaveBtn').removeClass(
