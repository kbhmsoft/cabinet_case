      ...
      <table class="table table-hover mb-6 font-size-h5">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>{{ en2bn($row->gov_case_register->case_no) ?? '' }}</td>
               <td>{{ en2bn($row->gov_case_register->date_issuing_rule_nishi) ?? '' }}</td>
               <td class="text-danger">
                   {{ en2bn(App\Models\gov_case\GovCaseHearing::select('hearing_date')->orderby('id', 'DESC')->where('gov_case_id', $row->gov_case_id)->first()->hearing_date ?? '') }}
                </td>
