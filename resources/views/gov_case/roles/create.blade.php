                    ...
                    <div class="modal-body">
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">ভূমিকা নাম <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="update_name_bn" name="name_bn"
                                    class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="name" class=" form-control-label">ভূমিকা নাম(ইংরেজি) <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="update_name" name="name" class="form-control form-control-sm"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="name" class=" form-control-label">অবস্থা<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="modal-body">
                        <div class="card-body card-block">
                            <div class="form-group">
                                <label for="name" class=" form-control-label">ভূমিকা নাম <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="name_bn" name="name_bn" placeholder="ভূমিকার নাম লিখুন"
                                    class="form-control form-control-sm" required>
                            ...
                            <div class="form-group">
                                <label for="name" class=" form-control-label">ভূমিকা নাম(ইংরেজি) <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="name" name="name" placeholder="ভূমিকার নাম লিখুন"
                                    class="form-control form-control-sm" required>
                                <span style="color: red">
                                    {{ $errors->first('name') }}
                                </span>
