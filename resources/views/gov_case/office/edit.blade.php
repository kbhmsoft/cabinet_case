                                ...
                                <div class="row">
                                        ...
                                        <select name="level" id="level" class="form-control w-100">
                                            ...
                                            @foreach ($office_type as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ $offices->level == $value->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-lg-8">
                                        ...
                                        <input type="text" id="office_name" name="office_name"
                                            placeholder="অফিসের নাম লিখুন" class="form-control form-control-sm"
                                            value="{{ $offices->office_name_bn }}">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio">
                                                <input type="radio" name="status" value="1"
                                                    {{ $offices->status == '1' ? 'checked' : '' }} />
                                                <span></span>এনাবল</label>
                                            <label class="radio">
                                                <input type="radio" name="status" value="0"
                                                    {{ $offices->status == '0' ? 'checked' : '' }} />
