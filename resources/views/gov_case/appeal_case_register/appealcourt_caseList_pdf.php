            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-center" style="margin-top: 0;"><span style="font-size:15px;">
                            আপিলবিভাগে সরকারি স্বার্থ সংশ্লিষ্ট মামলার তালিকা</p>
            ...
            foreach ($cases as $key => $row) {
                ?>
                    <tr>
                        ...
                        <td style="width: 10px;">
                            <?= en2bn($row->case_no) ?>/<?= en2bn($row->year) ?><br>
                            <?php if ($row->case_origin): ?>
                            (<?= en2bn($row->case_origin->case_no) ?>/<?= en2bn($row->case_origin->year) ?> নং
                            <?= $row->case_origin->case_category->name_bn ?> হতে উদ্ভূত)
                            <?php endif; ?>
                        </td>
                    ...
                    if ($subjectMatter !== null) {
                        $subjectMatterData = $subjectMatter['subject_matter'];
                    } else {
                        $subjectMatterData = '';
                    }
                    ?>
