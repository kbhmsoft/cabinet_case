                ...
                <div class="table-responsive ajax-data-container pt-3">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane" id="suspension_order" role="tabpanel" aria-labelledby="home-tab">
                            <form id="AppealOrderTakenForm" action="javascript:void(0)" class="form" method="POST"
                                ...
                                <div class="form-footer" style="display: flex;justify-content: center;">
                                    <button type="submit" id="appealOrderTakenSaveBtn"
...
@section('scripts')
    ...
    @include('gov_case.appeal_case_register._inc.action_js')
