...
<script type="text/javascript">
    ...
    /****************** Add Multiple বাস্তবায়নে গৃহীত ব্যবস্থার কপি সংযুক্ত করুন  *********/
    ...
    /****************** Add Multiple আপিল দায়েরের অনুরোধ কপি *********/
...
<script>
    ...
    $('#suspensionOrderForm').submit(function(e) {
        ...
        Swal.fire({
            title: 'আপনি কি মামলার স্থগিতাদেশের/অন্তর্বর্তীকালীন আদেশের বিষয়ের তথ্য সংরক্ষণ করতে চান?',
            // text: "You won't be able to revert this!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
...
<script>
    $('#AppealOrderTakenForm').submit(function(e) {
        e.preventDefault();
        $('#appealOrderTakenSaveBtn').addClass('spinner spinner-white spinner-right disabled');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('cabinet.case.appealOrderTakenStore') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: (data) => {
                        $('#appealOrderTakenSaveBtn').removeClass(
                            'spinner spinner-white spinner-right disabled');
                        $orderData = data;
                        Swal.fire(
                            'Saved!',
