    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{ route('cabinet.case.othersaction.sentToSolCaseStore') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <fieldset class="mb-8">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <input type="text" name="result_sending_date" id="result_sending_date"
                                            ...
                                            autocomplete="off" value="{{ $case->result_sending_date ?? '' }}" required="required">
                                    </div>
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <input type="text" name="result_sending_memorial" id="result_sending_memorial"
                                            ...
                                            autocomplete="off" value="{{ $case->result_sending_memorial ?? '' }}" required="required">
                                    </div>
                                </div>
