...
@section('title', 'প্রশাসনিক ট্রাইব্যুনাল ডাটা মাইগ্রেশন')
...
@section('content')
    <div class="card">
        <div class="card-body mb-5">
            ...
            <form id="dataMigrationForm" action="{{ route('data-migration-aat.store') }}" method="POST"
                ...
                <div class="mb-5">
                    <a href="{{ route('data-migration-aat.create') }}" class="btn btn-danger">বাতিল করুন</a>
