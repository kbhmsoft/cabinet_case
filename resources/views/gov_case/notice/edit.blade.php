...
<div class="row">
	<div class="col-lg-12">
		<div class="card card-custom gutter-b example example-compact">
			<form method="POST" action="{{route('cabinet.notice.update')}}">	
				@csrf
				<div class="card">
				    ...
				    <div class="card-body card-block row">
				        <div class="col-12">
				            <div class="form-group">
				                <label for="name" class=" form-control-label">নোটীশের বিস্তারিত <span class="text-danger">*</span></label>
                                    <textarea name="description" class="form-control" id="description" rows="3" spellcheck="false">{{ $notice->description }}</textarea>
				            </div>
				        </div>
				        <div class="col-4">
				            <div class="form-group">
			            ...
			            <div class="col-4">
			               	<div class="form-group">
			                    ...
			                    <input type="text" name="publish_date" id="publish_date" placeholder="প্রকাশের তারিখন" class="form-control form-control-sm  common_datepicker" value="{{ $notice->publish_date }}">
			                </div>
			            </div>
			             <div class="col-4">
				            <div class="form-group">
				                <label for="email" class=" form-control-label">মেয়াদ শেষ হওয়ার তারিখ</label>
				                <input type="text" id="expiry_date" name="expiry_date" placeholder="মেয়াদ শেষ হওয়ার তারিখ" class="form-control form-control-sm common_datepicker" value="{{ $notice->expiry_date }}">
				            </div>
				        </div>
				    </div>
			    </div>
			    <input type="hidden" name="case_id" value="{{ $notice->id }}">
