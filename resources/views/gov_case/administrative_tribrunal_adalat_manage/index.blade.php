    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap py-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('cabinet.administrative-tribunal-maintain.create') }}" class="btn btn-sm btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            @if ($AdministrativeTribrunalData && $AdministrativeTribrunalData->isEmpty())
            ...
            @else
                <table class="table table-hover mb-6 font-size-h6">
                    ...
                    <tbody>
                        @foreach ($AdministrativeTribrunalData as $key => $row)
                            <tr>
                                <th scope="row" class="tg-bn">{{ en2bn($key + $AdministrativeTribrunalData->firstItem()) }}</th>
                                <td>{{ $row->name }}</td>
                                ...
                                <td style="text-align:center;">
                                    <div style="display: flex; justify-content: space-between;">
                                        @if (auth()->user()->can('update_highcourt_adalat_info'))
                                            <a href="{{ route('cabinet.administrative-tribunal-maintain.edit', $row->id) }}"
                                        ...
                                        @if (auth()->user()->can('delete_highcourt_adalat_info'))
                                            <form action="{{ route('cabinet.administrative-tribunal-maintain.destroy', $row->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                ...
                {!! $AdministrativeTribrunalData->links() !!}
            @endif
        </div>
    </div>
    <!--end::Card-->
