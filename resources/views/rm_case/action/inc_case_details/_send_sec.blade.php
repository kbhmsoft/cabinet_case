            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="radio-list">
                                        @foreach ($roles as $key => $row)
                                            @if ($row->id == 9 || $row->id == 21 || $row->id == 5 || $row->id == 7|| $row->id == 22 || $row->id == 23 || $row->id == 24 || $row->id == 25)
                                                 ...
                                                 @php
                                                    ...
                                                    if ($row->id == 5 && $row->id != Auth::user()->role_id) {
                                                        $checked = 'checked';
                                                    } elseif($row->id == 7 && Auth::user()->role_id == 5) {
                                                        $checked = 'checked';
                                                    }
                                                    else {
                                                        $checked = '';
                    ...
                    <div class="modal-footer">
                        ...
                        {{-- <button type="button" id="formSubmit" class="btn btn-primary font-weight-bold font-size-h5 spinner spinner-white spinner-right">প্রাপককে পাঠিয়ে দিন</button> --}}
