{{-- {{ dd($info->result) }} minar --}}
    <div class="container" id="caseResultUpdate">
        ...
        <div class="mb-3">
            ...
            <span class="text-success flex-root font-weight-bold h1">{{ $info->result_text ?? '-' }}</span>
        </div>
        ...
        <div class="mb-3">
            ...
            <span class="text-dark flex-root font-weight-bold font-size-h6">"<?= // $info->govt_lost_reason ?>"</span>
        </div>
        @if ($info->result_file != null)
            <div class="my-5">
                <span class="text-dark-100 flex-root font-weight-bolder h2">মামলার ফলাফলের দলিল :</span><br>
