...
<!--begin::Row-->
@include('rm_case/action/inc_case_details/_send_sec')
<!--end::Row-->
            ...
            <div class="card-body px-0">
                <div class="tab-content pt-5">
                    ...
                    <div class="tab-pane active" id="tab_case_details" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_full_case')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    {{-- <div class="tab-pane" id="tab_sf" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_sf_tab')
                    </div> --}}
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_sf_report" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_final_sf')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_notice" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_case_activities')
                    </div>
                    <!--end::Tab Content-->
                    ...
                    <div class="tab-pane" id="tab_result" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_case_result')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_history" role="tabpanel">
                        @include('rm_case/action/inc_case_details/_case_history')
                    </div>
                    <!--end::Tab Content-->
                </div>
            </div>
...
@section('scripts')
   ...
   @include('rm_case.action.inc_case_details._script')
@endsection
