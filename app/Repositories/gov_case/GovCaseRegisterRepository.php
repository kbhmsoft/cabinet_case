...
//     }
    ...
    public static function checkAdministritiveTribrunalHighcourtAdalatExist($ATAdalatId)
    {
        if (isset($ATAdalatId)) {
            ...
            $ATAdalat = AdministrativeTribrunalHighcourtAdalat::find($ATAdalatId);
        } else {
...
// dd($caseInfo);
    ...
    {
        if ($caseId != null) {
            $case = AdministrativeTribrunalCaseRegister::find($caseId);
        } else {
    ...
    public static function storeAdministrativeTribrunalGeneralInfo($caseInfo)
    {
        try {
    ...
    public static function storeOrderTaken($caseInfo)
    {
