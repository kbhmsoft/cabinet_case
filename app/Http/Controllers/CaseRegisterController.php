...
class CaseRegisterController extends Controller
{
    ...
    public function old_case_create()
    {
        ...
        $data['page_title'] = 'পুরাতন মামলা রেজিষ্টার এন্ট্রি ফরম'; //exit;
        // return view('case.case_add', compact('page_title', 'case_type'));
    ...
    */
    ...
    public function getdependentDoptor($id)
    {
        $getdependentDoptor = Office::whereIn('level', [10,11,12])->where('parent', $id)->pluck("office_name_bn","id");
